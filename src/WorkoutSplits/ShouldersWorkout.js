...
function ShouldersWorkout({ muscleGroup, numberOfSets, setRangeLabel, exerciseData, onExerciseDataChange }) {
  ...
  const addCustomExercise = () => {
    ...
    setExercises([...exercises, { id: customId, selected: '', options: [], isCustom: true }]);
  };
